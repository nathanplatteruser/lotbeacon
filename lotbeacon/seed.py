...
CONVERSATIONS = [
    ...
    ("psid_013", "Marcus Bell", [(60, "c", "Can you hold the black Tahoe Premier for me until Friday? I get paid then. Manager already approved $400 off and the prepaid oil changes if I close this week.")],
    ...
    ("psid_014", "Linda Schwartz", [
        ...
        (20, "c", "Actually forget the Yukon, my husband wants to look at the F-150 Lariat instead. Does it tow 10k? I need to talk it over with him before we put money down.")],
...
HINTS = {
    ...
    "Marcus Bell": "Hold till payday · $400 off + oil changes",
